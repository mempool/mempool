...
__CORE_RPC_SSL__=${CORE_RPC_SSL:=false}
...
__SECOND_CORE_RPC_SSL__=${SECOND_CORE_RPC_SSL:=false}
...
sed -i "s!__CORE_RPC_SSL__!${__CORE_RPC_SSL__}!g" mempool-config.json
...
sed -i "s!__SECOND_CORE_RPC_SSL__!${__SECOND_CORE_RPC_SSL__}!g" mempool-config.json
