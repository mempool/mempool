...
export class PoolRankingComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.widget) {
      ...
      this.seoService.setDescription($localize`:@@meta.description.bells.graphs.pool-ranking:See the top Bells mining pools ranked by number of blocks mined, over your desired timeframe.`);
