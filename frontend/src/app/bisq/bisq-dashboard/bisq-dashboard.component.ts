...
export class BisqDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.bisq.markets:Explore the full Bells ecosystem with The Mempool Open Source Project™. See Bisq market prices, trading activity, and more.`);
