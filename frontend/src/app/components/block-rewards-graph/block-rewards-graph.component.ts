...
export class BlockRewardsGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.bells.graphs.block-rewards:See Bitcoin block rewards in BEL and USD visualized over time. Block rewards are the total funds miners earn from the block subsidy and fees.`);
