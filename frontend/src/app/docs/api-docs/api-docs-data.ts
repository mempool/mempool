...
export const faqData = [
  ...
  },
  {
    ...
    answer: "<p>See real-time fee estimates on <a href='/'>the main dashboard</a>.</p><p>Fiat fee values shown are based on the average native segwit transaction size of 140 vBytes.</p><p>Note that Mempool's fee estimation algorithm tries to suggest the lowest fees wherever possible, but because activity on the Bitcoin network is not perfectly predictable, fee estimation cannot be perfectly precise.</p><p>Here is an overview of the suggested feerates:</p><ul><li><b>No Priority.</b> Use this suggested fee to pay the least if you are ok with confirmation taking a while.</li><li><b>Low Priority.</b> Use this suggested fee if you want confirmation within the next few blocks but don't need it particularly quickly.</li><li><b>Medium Priority.</b> Use this suggested fee if you want fast confirmation within the next few blocks.</li><li><b>High Priority.</b> This most expensive suggested fee is meant for urgent confirmation, potentially in the next block.</li></ul>"
  },
  {
    type: "endpoint",
    category: "how-to",
