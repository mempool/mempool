...
1) One-click installation on: [Umbrel](https://github.com/getumbrel/umbrel), [RaspiBlitz](https://github.com/rootzoll/raspiblitz), [RoninDojo](https://github.com/RoninDojo/RoninDojo), or [MyNode](https://github.com/mynodebtc/mynode).
