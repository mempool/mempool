...
class Statistics {
    ...
    async $create(statistics) {
        try {
            ...
            logger_1.default.err('$create() error' + e.message || e);
        }
    }
    getQueryForDays(div) {
    ...
    async $get(id) {
        try {
            ...
            logger_1.default.err('$list2H() error' + e.message || e);
        }
    }
    async $list2H() {
        try {
    ...
    async $list24H() {
        try {
            ...
            logger_1.default.err('$list24h() error' + e.message || e);
            return [];
        }
    }
    async $list1W() {
        try {
            ...
            logger_1.default.err('$list1W() error' + e);
            return [];
        }
    }
    async $list1M() {
        try {
            ...
            logger_1.default.err('$list1M() error' + e);
            return [];
        }
    }
    async $list3M() {
        try {
            ...
            logger_1.default.err('$list3M() error' + e);
            return [];
        }
    }
    async $list6M() {
        try {
            ...
            logger_1.default.err('$list6M() error' + e);
            return [];
        }
    }
    async $list1Y() {
    ...
    mapStatisticToOptimizedStatistic(statistic) {
