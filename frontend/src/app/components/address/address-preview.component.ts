    ...
    this.mainSubscription = this.route.paramMap
      .pipe(
        switchMap((params: ParamMap) => {
          ...
          this.seoService.setDescription($localize`:@@meta.description.bells.address:See mempool transactions, confirmed transactions, balance, and more for ${this.stateService.network==='liquid'||this.stateService.network==='liquidtestnet'?'Liquid':'Bells'} ${seoDescriptionNetwork(this.stateService.network)} address ${this.addressString}:INTERPOLATION:.`);
