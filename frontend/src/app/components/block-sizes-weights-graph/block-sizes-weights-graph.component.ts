...
export class BlockSizesWeightsGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.bells.graphs.block-sizes:See Bells block sizes (MB) and block weights (weight units) visualized over time.`);
