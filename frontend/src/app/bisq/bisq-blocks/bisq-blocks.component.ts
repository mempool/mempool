...
export class BisqBlocksComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.bisq.blocks:See a list of recent Bells blocks with BSQ transactions, total BSQ sent per block, and more.`);
