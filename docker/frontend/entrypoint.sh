...
sed -i.bak -e "s/__MEMPOOL_BACKEND_MAINNET_HTTP_HOST__/${__MEMPOOL_BACKEND_MAINNET_HTTP_HOST__}/g" /etc/nginx/conf.d/nginx-mempool.conf && rm /etc/nginx/conf.d/nginx-mempool.conf.bak
sed -i.bak -e "s/__MEMPOOL_BACKEND_MAINNET_HTTP_PORT__/${__MEMPOOL_BACKEND_MAINNET_HTTP_PORT__}/g" /etc/nginx/conf.d/nginx-mempool.conf && rm /etc/nginx/conf.d/nginx-mempool.conf.bak

cp /etc/nginx/nginx.conf /patch/nginx.conf
sed -i.bak -e "s/__MEMPOOL_FRONTEND_HTTP_PORT__/${__MEMPOOL_FRONTEND_HTTP_PORT__}/g" /patch/nginx.conf && rm /patch/nginx.conf.bak
