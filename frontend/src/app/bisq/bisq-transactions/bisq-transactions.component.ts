...
export class BisqTransactionsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.bisq.transactions:See recent BSQ transactions: amount, txid, associated Bells block, transaction type, and more.`);
