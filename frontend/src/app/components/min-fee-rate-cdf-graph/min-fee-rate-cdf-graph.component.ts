...
export class MinFeeRateCdfGraphComponent implements OnInit {
  ...
  updateChart(): void {
    this.percentBelow = this.minFeeRateService.getStats(this.data, this.threshold).percentBelow;
  ...
  prepareChartOptions(cdf: number[][]): void {
    ...
    this.chartOptions = {
      ...
      animation: false,
      grid: {
        right: this.widget ? 10 : 30,
        left: this.widget ? 45 : 65,
        bottom: this.widget ? 30 : 75,
        top: 20,
      },
      legend: (this.widget || !hasData) ? undefined : {
        bottom: 0,
        left: 'center',
        width: '90%',
      ...
      xAxis: !hasData ? undefined : {
        name: this.widget ? undefined : $localize`:@@mining.min-fee-rate-cdf.x-axis:fee rate (sat/vB)`,
        nameLocation: 'middle',
        nameTextStyle: {
      ...
      yAxis: !hasData ? undefined : {
        position: 'left',
        name: this.widget ? undefined : $localize`:@@mining.min-fee-rate-cdf.y-axis:% of days`,
        nameLocation: 'middle',
        nameRotate: 90,
        nameGap: 42,
        nameTextStyle: {
