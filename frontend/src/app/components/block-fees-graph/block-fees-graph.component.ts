...
export class BlockFeesGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.bells.graphs.block-fees:See the average mining fees earned per Bells block visualized in BEL and USD over time.`);
