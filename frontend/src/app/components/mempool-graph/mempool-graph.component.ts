...
export class MempoolGraphComponent implements OnInit, OnChanges {
  ...
  mountFeeChart() {
    ...
    const labelsDataLocal = labelsData(labels, this.template, this.windowPreference);

    const seriesGraph = [];
    const newColors = [];
    const labelsFiltered = filterLabelDates(labelsDataLocal, this.template, this.windowPreference);
