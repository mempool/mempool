...
export class LightningStatisticsChartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.widget) {
      ...
      this.seoService.setDescription($localize`:@@meta.description.lightning.stats-chart:See the capacity of the Lightning network visualized over time in terms of the number of open channels and total bells capacity.`);
