  ...
  ngOnInit(): void {
    ...
    this.subscription = this.route.paramMap
      ...
      .subscribe((block: BisqBlock) => {
        ...
        this.seoService.setDescription($localize`:@@meta.description.bisq.block:See all BSQ transactions in Bells block ${block.height}:BLOCK_HEIGHT: (block hash ${block.hash}:BLOCK_HASH:).`);
        this.block = block;
      });
  }
